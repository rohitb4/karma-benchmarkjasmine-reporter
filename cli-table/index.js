/**
  Forked cli-table node module, extended to support colors for indidual cells.
*/
/**
 * Module dependencies.
 */
...
Table.prototype.toString = function (){
  ...
  function generateRow (items, style) {
    ...
    items.forEach(function (item, i) {
      var msg = item.msg || item;
      var contents = msg.toString().split("\n").reduce(function (memo, l) {
      ...
      cells.push({ contents: contents , height: height, style: style || item.style });
    });
    ...
    cells.forEach(function (cell, i) {
      cell.contents.forEach(function (line, j) {
        ...
        //if (style || (first_cell_head && i === 0 && options.style.head)) {
          line = applyStyles(cell.style || [], line)
        //}
